...
-- A despejar dados para tabela template_legacy.addon_account_data: ~0 rows (aproximadamente)
...
-- A despejar dados para tabela template_legacy.licenses: ~0 rows (aproximadamente)
